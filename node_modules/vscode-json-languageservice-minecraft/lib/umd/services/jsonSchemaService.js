(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "jsonc-parser", "vscode-uri", "../utils/strings", "../parser/jsonParser", "../minecraftServices/minecraftSchemas", "vscode-nls"], factory);
    }
    ...
    var minecraftSchemas_1 = require("../minecraftServices/minecraftSchemas");
    ...
    var JSONSchemaService = /** @class */ (function () {
        function JSONSchemaService(requestService, contextService, promiseConstructor) {
            ...
            this.minecraftSchemas = new minecraftSchemas_1.MinecraftSchemas();
        }
        ...
        JSONSchemaService.prototype.getSchemaForResource = function (resource, document) {
            ...
            if (document && document.root && document.root.type === 'object') {
                ...
                if (schemaProperties.length > 0) {
                    ...
                    if (schemeId) {
                        var id_1 = this.normalizeId(schemeId);
                        return this.getOrAddSchemaHandle(id_1).getResolvedSchema();
                    }
                }
            }
            ...
            var id = this.minecraftSchemas.getMinecraftSchemaId(document);
            if (id) {
