...
public class ModPlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> EBONY_PLACE_KEY = createKey("ebony_placed");

    public static final ResourceKey<PlacedFeature> OVERWORLD_BLACK_OPAL_PLACED_KEY = createKey("black_opal_placed");
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        register(context, EBONY_PLACE_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.EBONY_KEY),
            VegetationPlacements.treePlacement(PlacementUtils.countExtra(3, 0.1f, 2), ModBlock.EBONY_SAPLING.get()));
        register(context, OVERWORLD_BLACK_OPAL_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.OVERWORLD_BLACK_OPAL_ORE_KEY),
