package net.frozencheesecat.testmod.worldgen;
...
public class ModConfiguredFeatures {
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> NETHER_BLACK_OPAL_ORE_KEY = registerKey("end_black_opal_ore");
    public static final ResourceKey<ConfiguredFeature<?, ?>> END_BLACK_OPAL_ORE_KEY = registerKey("nether_black_opal_ore");
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
        ...
        List<OreConfiguration.TargetBlockState> overworldBlackOpalOres = List.of(
            OreConfiguration.target(stoneReplaceables,ModBlock.BLACK_OPAL_ORE.get().defaultBlockState()),
            OreConfiguration.target(deepslateReplaceables, ModBlock.DEEPSLATE_BLACK_OPAL_ORE.get().defaultBlockState()));
        ...
        register(context, END_BLACK_OPAL_ORE_KEY, Feature.ORE, new OreConfiguration(endstoneReplaceables,
            ModBlock.ENDSTONE_BLACK_OPAL_ORE.get().defaultBlockState(), 9));
        register(context, NETHER_BLACK_OPAL_ORE_KEY, Feature.ORE, new OreConfiguration(netherrackReplaceables,
            ModBlock.NETHERRACK_BLACK_OPAL_ORE.get().defaultBlockState(), 9));
